...
<title>Sign in — AccessiMind</title>
<style>
...
<body>
<a href="#main" class="skip-link" style="position:absolute;top:-9999px;left:1rem;z-index:9999;padding:0.75rem 1rem;background:#fff;color:#000;border:2px solid #000;font-weight:bold;" onfocus="this.style.top='1rem'" onblur="this.style.top='-9999px'">Ana içeriğe geç</a>
<main id="main">
  <div class="brand">Nous<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the AccessiMind dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — AccessiMind</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
